...
#define LIN_MAX 100  //LINE_MAX 10 seklinde birakinca 2 hata aliyorum.
                     //1- LINE_MAX redefined 2- pgm_info.comment tam okunmuyor  
...
typedef struct {
    ...
    char comment[LIN_MAX];         // opsiyonel yorum satiri
